...
public:
	...
	void DrawLines(std::vector<sf::Vector2f> points, sf::Color color = sf::Color::White);
	...
	sf::Vector2f AddDefaultTranslation(sf::Vector2f vector) const;
	sf::Vector2f AddDefaultRotation(sf::Vector2f vector) const;
	sf::Vector2f AddDefaultScale(sf::Vector2f vector) const;
